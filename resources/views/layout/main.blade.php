...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/"
                                class="nav-link {{ request()->is('admin/dashboard') ? 'bg-success' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('purchase') }}"
                                class="nav-link {{ request()->is('purchase*') ? 'bg-success' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Pembelian
                                </p>
    ...
    <script>
        $(document).ready(function() {
            $('#example1').DataTable({
                responsive: false
                // scrollX: true // Tambahkan scrollbar horizontal jika diperlukan
            });

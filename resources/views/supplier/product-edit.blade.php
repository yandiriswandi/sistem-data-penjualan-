                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                @foreach ($suppliers as $supplier)
                                                    <div>
                                                        <input type="checkbox" id="supplier{{ $supplier->id }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="{{ old('stock', $product->price) }}" name="price"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="note" id="note" class="form-control @error('note') is-invalid @enderror" cols="10"
                                                    rows="5" placeholder="Enter your note here">{{ old('note', $product->note) }}</textarea>
                                                @error('note')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>

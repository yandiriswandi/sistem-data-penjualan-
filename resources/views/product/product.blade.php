    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <a href="{{ route('product-add') }}" class="btn btn-primary mb-3">Tambah Data</a>
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <table id="example1" class="table table-hover table-responsive text-nowrap">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Nama</th>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <form
                                                                action="{{ route('product.delete', ['id' => $d->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
